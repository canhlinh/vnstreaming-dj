package com.vnstreaming.ffmpeg.options;
...
public class VideoEncodingOptions {
	...
	public VideoEncodingOptions(boolean enabled, String codec, Fraction frame_rate, int width, int height, int bit_rate, Integer frames, String filter, String preset) {
